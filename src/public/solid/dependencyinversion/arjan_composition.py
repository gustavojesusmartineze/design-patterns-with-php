...
class Commission:
    ...
    def get_payment(self) -> float:
        """Get the payment for the commission."""
...
@dataclass
class HourlyContract(Contract, Commission):
...
@dataclass
class SalariedContract(Contract, Commission):
...
@dataclass
class FreelancerContract(Contract, Commission):
    """Contract type for an employee that's paid based on number of worked hours."""
...
def main() -> None:
    ...
    sarah_commission = ContractCommission(commission=100, contracts_landed=10)
